'''
Module with a class that tracks information about training.
'''
...
class TrainingTracker():
    ...
    def make_key_fig(self, keys: list = None, kwargs=None, title=""):
        ...
        fig.savefig(self.config["logdir"] + "/" + keys[0] + "_fig")#self.config["logdir"]+"/key_fig")
    
    def to_json(self):
        filename = self.config["logdir"]+"/TrainingTracker_metrics.json"
